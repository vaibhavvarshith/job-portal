...
const ProfileSkeleton = () => (
  <>
    ...
    <div className="company-profile-container">
      <div
        className="profile-banner-section skeleton-box"
        style={{ height: "200px" }}
      ></div>
      <div className="profile-header-main" style={{ alignItems: "center" }}>
        ...
        ></div>
        <div
          className="profile-company-name-tagline"
        ...
        >
          ...
          <div
            ...
            style={{ height: "24px", width: "200px", marginTop: "10px" }}
          ></div>
        </div>
      </div>
      <div
        className="form-section-profile skeleton-box"
    ...
    const fetchProfile = async () => {
      ...
      try {
        const response = await fetch(
          `${import.meta.env.VITE_BACKEND_URL}/api/profile/recruiter`,
          {

        ...
        const fetchData = async () => {
            ...
            try {
                ...
                const [statsRes, appsRes, profileRes] = await Promise.all([
                    fetch('http://localhost:5000/api/recruiter/dashboard-stats', { headers: { 'Authorization': `Bearer ${token}` } }),
                    fetch('http://localhost:5000/api/recruiter/recent-applications', { headers: { 'Authorization': `Bearer ${token}` } }),
